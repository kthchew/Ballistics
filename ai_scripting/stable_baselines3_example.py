...
if args.resume_model_path is None:
    ...
    # model: PPO = PPO("MultiInputPolicy", env, verbose=1, n_epochs=10, learning_rate=0.0003, clip_range=0.2, ent_coef=0.00, n_steps=2048, batch_size=256, tensorboard_log=args.experiment_dir,
    #                 policy_kwargs=dict(net_arch=dict(pi=[256,256], vf=[256,256,256]), log_std_init=-1.0), gamma=0.97)
else:
